...
public class Webtable {
    ...
    public static void webtableToExcel() {
        ...
        try {
            ...
            oBrowser.navigate().to("file:///C:/Users/HP/Desktop/Testig%20note/html%20program/table.html");
            Thread.sleep(2000);
            ...
            fout = new FileOutputStream("D:\\evening\\auto\\Megha\\StudentDetails.xlsx");
            wb.write(fout);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
