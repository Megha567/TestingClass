    ...
    public static void main(String[] args) {
        ...
        public static void uploadResumeInNaukri(){
            ...
            try{
                ...
                oBrowser.findElement(By.xpath("//input[@id='email']")).sendKeys("sgTesting1@sg1.com");
                ...
                oBrowser.findElement(By.xpath("//input[@id='resumeUpload']")).sendKeys("E:\\MorningBatch_Combined\\CoreJava\\MyResume.docx");
